...
<body class="container display-4">
           <h1 class="text-white shadow-lg">All The Doctor's Of  surgeon</h1>
...
include("../connection.php");
       ...
       $query = "SELECT * 
                      FROM doctor inner join consulting_schedule on consulting_schedule.d_id=doctor.id  where permission='approved' AND specialist like's%' OR permission='Added' AND specialist like's%' ";
